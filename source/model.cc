...
Keybd::Keybd(void) : _pedal(false)
{
    *_label = 0;
}

Ifelm::Ifelm(void) : _state(0)
{
    *_label = 0;
    *_mnemo = 0;
}

Group::Group(void) : _nifelm(0)
{
    *_label = 0;
}
...
void Model::set_ifelm(int g, int i, int m)
{
    ...
    if (I->_state != s)
    {
        ...
        if (_qcomm->write_avail())
        {
            ...
            send_event (TO_OSC, new M_ifc_ifelm (MT_IFC_ELCLR + s, g, i));
        }
    }
}
