...
H_scale::H_scale(X_window *parent, X_callback *callb, int xp, int yp) : X_window(parent, xp, yp, 778, 18, Colors.main_bg),
                                                                        _callb(callb)
{
...
N_scale::N_scale(X_window *parent, X_callback *callb, int xp, int yp) : X_window(parent, xp, yp, 778, 18, Colors.main_bg), _callb(callb)
{
    x_add_events(ExposureMask | ButtonPressMask);
    x_map();
}
...
Editwin::Editwin(X_window *parent, X_callback *callb, int xp, int yp, X_resman *xresm) : X_window(parent, xp, yp, 100, 100, Colors.main_bg),
                                                                                         _callb(callb),
                                                                                         _xresm(xresm)
{
    int i, x, y;
...
void Editwin::handle_callb(int k, X_window *W, XEvent *E)
{
    ...
    case CB_MS_UND:
    {
        ...
        case TAB_ATT:
            if (M == _att_msl)
                msl_update(&_edit->_h_att, _att_msl, _att_fun, 0, d, _att_harm, _att_note);
            else
                msl_update(&_edit->_h_atp, _atp_msl, _att_fun, 1, d, _att_harm, _att_note);
            break;
        case TAB_RAN:
    ...
    case CB_FW_UND:
    {
        ...
        case TAB_ATT:
            if (f)
                fun_update(&_edit->_h_atp, _atp_msl, _att_fun, d, _att_harm, _att_note);
            else
                fun_update(&_edit->_h_att, _att_msl, _att_fun, d, _att_harm, _att_note);
            break;
        case TAB_RAN:
